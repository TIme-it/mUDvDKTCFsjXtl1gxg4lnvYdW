<?php
	class users extends app_model {
		...
		//¬ыборка прав роли (дл€ запоминани€ при авторизации)
		...
		//ѕроверка существовани€ логина кроме того, чей id указан
		...
		//ѕроверка существовани€ названи€ роли
		...
		//ѕроверка существовани€ названи€ роли кроме той, чей id указан
		...
		//¬ыборка количества пользователей с каждой ролью
		...
		//—писок всех страниц (из указанного множества access, если он задан)
		...
		//—писок id страниц, на которые есть доступ
		public function getAccessPages($role_id) {
			if ($role_id == 0)	//ƒл€ главного админа
